...
#SBATCH --output=/projects/airi/srares/powerbi-agent/logs/download-qwen36-27b-%j.out
#SBATCH --error=/projects/airi/srares/powerbi-agent/logs/download-qwen36-27b-%j.err
